...
This project is being developed **openly** and invites contributions from **anyone interested** in ethical and responsible AI frameworks, policy, and tools development.
You can suggest topics to include in this repository, report mistakes/bugs, create Pull Requests to fix an error, offer resources or help develop or review materials.
...
🎉 It's my life's mission to ensure AI is developed and used in an ethical and responsible way
---
...
For any organisation related queries or concerns, you can directly reach out to the **First EthicalAI team by emailing [info@firstethicalai.org](mailto:info@firstethicalai.org)**.

♻️ License
---

This work is licensed under the **MIT license (code) and Creative Commons BY-SA 4.0 International license (for documentation)**. 
